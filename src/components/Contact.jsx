    ...
    <>
      <div className='bg-purple-700 pt-20 pb-10 mx-auto'>
        ...
        <div className='flex mx-auto mb-5'>
          <div className='flex px-12 py-12 mx-auto justify-center bg-black text-white rounded-3xl shadow-2xl shadow-black'>
            <div className='flex justify-center border-2 p-4 rounded-xl'>
              <div className='mr-4 items-center'>nileshbjadhawar@gmail.com</div>
              <div className='bg-yellow-500 rounded-3xl p-2'>
                <a target="_blank" href="mailto:nileshbjadhawar@gmail.com">Mail ME</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='flex mx-auto mb-5'>
          <div className='flex px-12 py-12 mx-auto justify-center bg-black text-white rounded-3xl shadow-2xl shadow-black'>
            <div className='flex justify-center border-2 p-4 rounded-xl'>
              ...
              <div className='bg-yellow-500 rounded-3xl p-2'>
                <a target="_blank" href="https://wa.me/message/Y37N46MVEZIZC1">WhatsApp Me</a>
              </div>
            </div>
          </div>
        </div>
